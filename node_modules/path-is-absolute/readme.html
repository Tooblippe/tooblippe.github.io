...
<!--      </nav>-->
      <article id="main" class="content">
        <h1 id="path-is-absolute">path-is-absolute <a href="https://travis-ci.org/sindresorhus/path-is-absolute"><img src="https://travis-ci.org/sindresorhus/path-is-absolute.svg?branch=master" alt="Build Status"></a> <a class="heading-anchor-permalink" href="#path-is-absolute">#</a></h1>
<blockquote>
...
<h3 id="pathisabsolute(path)">pathIsAbsolute(path) <a class="heading-anchor-permalink" href="#pathisabsolute(path)">#</a></h3>
<h3 id="pathisabsolute.posix(path)">pathIsAbsolute.posix(path) <a class="heading-anchor-permalink" href="#pathisabsolute.posix(path)">#</a></h3>
<p>POSIX specific version.</p>
<h3 id="pathisabsolute.win32(path)">pathIsAbsolute.win32(path) <a class="heading-anchor-permalink" href="#pathisabsolute.win32(path)">#</a></h3>
