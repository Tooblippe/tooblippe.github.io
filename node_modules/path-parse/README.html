...
<!--      </nav>-->
      <article id="main" class="content">
        <h1 id="path-parse">path-parse <a href="https://travis-ci.org/jbgutierrez/path-parse"><img src="https://travis-ci.org/jbgutierrez/path-parse.svg?branch=master" alt="Build Status"></a> <a class="heading-anchor-permalink" href="#path-parse">#</a></h1>
<blockquote>
...
<h3 id="pathparse(path)">pathParse(path) <a class="heading-anchor-permalink" href="#pathparse(path)">#</a></h3>
<h3 id="pathparse.posix(path)">pathParse.posix(path) <a class="heading-anchor-permalink" href="#pathparse.posix(path)">#</a></h3>
<p>The Posix specific version.</p>
<h3 id="pathparse.win32(path)">pathParse.win32(path) <a class="heading-anchor-permalink" href="#pathparse.win32(path)">#</a></h3>
