...
<!--      </nav>-->
      <article id="main" class="content">
        <h1 id="rechoir">rechoir <a href="http://travis-ci.org/tkellen/js-rechoir"><img src="https://secure.travis-ci.org/tkellen/js-rechoir.png" alt="Build Status"></a> <a class="heading-anchor-permalink" href="#rechoir">#</a></h1>
<blockquote>
...
<h2 id="what-is-it%3F">What is it? <a class="heading-anchor-permalink" href="#what-is-it%3F">#</a></h2>
...
<h3 id="prepare(config%2C-filepath%2C-requirefrom)">prepare(config, filepath, requireFrom) <a class="heading-anchor-permalink" href="#prepare(config%2C-filepath%2C-requirefrom)">#</a></h3>
...
<h4 id="usage">Usage <a class="heading-anchor-permalink" href="#usage">#</a></h4>
