...
<!--      </nav>-->
      <article id="main" class="content">
        <h1 id="glob">Glob <a class="heading-anchor-permalink" href="#glob">#</a></h1>
...
<h2 id="glob-primer">Glob Primer <a class="heading-anchor-permalink" href="#glob-primer">#</a></h2>
...
<h3 id="dots">Dots <a class="heading-anchor-permalink" href="#dots">#</a></h3>
...
<h3 id="basename-matching">Basename Matching <a class="heading-anchor-permalink" href="#basename-matching">#</a></h3>
...
<h3 id="empty-sets">Empty Sets <a class="heading-anchor-permalink" href="#empty-sets">#</a></h3>
...
<h3 id="see-also%3A">See Also: <a class="heading-anchor-permalink" href="#see-also%3A">#</a></h3>
<ul>
...
<h2 id="glob.hasmagic(pattern%2C-%5Boptions%5D)">glob.hasMagic(pattern, [options]) <a class="heading-anchor-permalink" href="#glob.hasmagic(pattern%2C-%5Boptions%5D)">#</a></h2>
...
options.</p>
<h2 id="glob(pattern%2C-%5Boptions%5D%2C-cb)">glob(pattern, [options], cb) <a class="heading-anchor-permalink" href="#glob(pattern%2C-%5Boptions%5D%2C-cb)">#</a></h2>
<ul>
...
<h2 id="glob.sync(pattern%2C-%5Boptions%5D)">glob.sync(pattern, [options]) <a class="heading-anchor-permalink" href="#glob.sync(pattern%2C-%5Boptions%5D)">#</a></h2>
<ul>
<li><code>pattern</code> <code>{String}</code> Pattern to be matched</li>
<li><code>options</code> <code>{Object}</code></li>
...
<h2 id="class%3A-glob.glob">Class: glob.Glob <a class="heading-anchor-permalink" href="#class%3A-glob.glob">#</a></h2>
...
immediately.</p>
<h3 id="new-glob.glob(pattern%2C-%5Boptions%5D%2C-%5Bcb%5D)">new glob.Glob(pattern, [options], [cb]) <a class="heading-anchor-permalink" href="#new-glob.glob(pattern%2C-%5Boptions%5D%2C-%5Bcb%5D)">#</a></h3>
<ul>
...
<h3 id="properties">Properties <a class="heading-anchor-permalink" href="#properties">#</a></h3>
<ul>
...
<h2 id="comparisons-to-other-fnmatch%2Fglob-implementations">Comparisons to other fnmatch/glob implementations <a class="heading-anchor-permalink" href="#comparisons-to-other-fnmatch%2Fglob-implementations">#</a></h2>
...
<h3 id="comments-and-negation">Comments and Negation <a class="heading-anchor-permalink" href="#comments-and-negation">#</a></h3>
...
<h2 id="race-conditions">Race Conditions <a class="heading-anchor-permalink" href="#race-conditions">#</a></h2>
...
<h2 id="glob-logo">Glob Logo <a class="heading-anchor-permalink" href="#glob-logo">#</a></h2>
...
<h2 id="contributing">Contributing <a class="heading-anchor-permalink" href="#contributing">#</a></h2>
