...
<!--      </nav>-->
      <article id="main" class="content">
        <h1 id="minimatch">minimatch <a class="heading-anchor-permalink" href="#minimatch">#</a></h1>
...
<h2 id="minimatch-class">Minimatch Class <a class="heading-anchor-permalink" href="#minimatch-class">#</a></h2>
...
<h3 id="minimatch(path%2C-pattern%2C-options)">minimatch(path, pattern, options) <a class="heading-anchor-permalink" href="#minimatch(path%2C-pattern%2C-options)">#</a></h3>
...
<h3 id="minimatch.filter(pattern%2C-options)">minimatch.filter(pattern, options) <a class="heading-anchor-permalink" href="#minimatch.filter(pattern%2C-options)">#</a></h3>
...
<h3 id="minimatch.match(list%2C-pattern%2C-options)">minimatch.match(list, pattern, options) <a class="heading-anchor-permalink" href="#minimatch.match(list%2C-pattern%2C-options)">#</a></h3>
...
<h3 id="minimatch.makere(pattern%2C-options)">minimatch.makeRe(pattern, options) <a class="heading-anchor-permalink" href="#minimatch.makere(pattern%2C-options)">#</a></h3>
...
<h3 id="nobrace">nobrace <a class="heading-anchor-permalink" href="#nobrace">#</a></h3>
<p>Do not expand <code>{a,b}</code> and <code>{1..3}</code> brace sets.</p>
<h3 id="noglobstar">noglobstar <a class="heading-anchor-permalink" href="#noglobstar">#</a></h3>
<p>Disable <code>**</code> matching against multiple folder names.</p>
<h3 id="dot">dot <a class="heading-anchor-permalink" href="#dot">#</a></h3>
...
is set.</p>
<h3 id="noext">noext <a class="heading-anchor-permalink" href="#noext">#</a></h3>
<p>Disable “extglob” style patterns like <code>+(a|b)</code>.</p>
<h3 id="nocase">nocase <a class="heading-anchor-permalink" href="#nocase">#</a></h3>
<p>Perform a case-insensitive match.</p>
<h3 id="nonull">nonull <a class="heading-anchor-permalink" href="#nonull">#</a></h3>
...
<h3 id="matchbase">matchBase <a class="heading-anchor-permalink" href="#matchbase">#</a></h3>
...
<h3 id="nocomment">nocomment <a class="heading-anchor-permalink" href="#nocomment">#</a></h3>
<p>Suppress the behavior of treating <code>#</code> at the start of a pattern as a
comment.</p>
<h3 id="nonegate">nonegate <a class="heading-anchor-permalink" href="#nonegate">#</a></h3>
<p>Suppress the behavior of treating a leading <code>!</code> character as negation.</p>
<h3 id="flipnegate">flipNegate <a class="heading-anchor-permalink" href="#flipnegate">#</a></h3>
