...
<!--      </nav>-->
      <article id="main" class="content">
        <h1 id="once">once <a class="heading-anchor-permalink" href="#once">#</a></h1>
...
<h2 id="once.strict(func)"><code>once.strict(func)</code> <a class="heading-anchor-permalink" href="#once.strict(func)">#</a></h2>
